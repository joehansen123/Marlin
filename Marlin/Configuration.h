...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 55.46
  #define  DEFAULT_Ki 9.40
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.06   // Z offset: -below +above  [the nozzle]
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,3200,200}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 30, 300}    // (mm/sec)
